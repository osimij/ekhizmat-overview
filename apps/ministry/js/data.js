...
(function (global) {
  ...
  var I18N = {
    ru: {
      ...
      form_preview_mode: 'Как видит гражданин',
      ...
      ij_count: 'запросов',
      rep_period: 'Период',
      forms_comments_chip: '{n} комментария',
      form_preview_caption: 'Предпросмотр · вид гражданина',
      ...
      lock_password_required: 'Введите пароль, чтобы продолжить.',
      close: 'Закрыть'
    },
    tg: {
      ...
      form_preview_mode: 'Чӣ тавр шаҳрванд мебинад',
      ...
      ij_count: 'дархост',
      rep_period: 'Давра',
      forms_comments_chip: '{n} шарҳ',
      form_preview_caption: 'Пешнамоиш · назари шаҳрванд',
      ...
      lock_password_required: 'Барои идома гузарвожаро ворид кунед.',
      close: 'Пӯшидан'
    }
  };

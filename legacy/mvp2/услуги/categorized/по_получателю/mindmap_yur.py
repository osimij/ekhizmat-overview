# -*- coding: utf-8 -*-
"""Интерактивный mindmap (markmap HTML): 12 групп юр.лицо -> услуги (рус. названия из xlsx)."""
import csv, re, openpyxl

XLSX = '../../Феҳристи_хизматрасониҳои_давлатӣ_бо_за_бони_руссӣ.xlsx'
SRC  = 'все_услуги_юр_лицо_сгруппировано.csv'
OUT  = 'mindmap_юр_лицо.html'
RU_FROM, RU_TO = 1224, 2415   # русская половина файла

GROUP_ORDER = [
    'Лицензии и разрешения', 'Налоги и штрафы', 'Юстиция и нотариат', 'Транспорт',
    'Земля и недвижимость', 'Здоровье', 'Образование', 'Культура, спорт, туризм',
    'Документы и аккредитация', 'Справки и выписки', 'Ведомства', 'Прочее',
]
...
def main():
    ...
    lines.append(f'# Услуги для юридических лиц ({total})')
...
<title>Mindmap — услуги для юридических лиц</title>
<style>

...
function railTr(s){ try{ var l=localStorage.getItem("ekh-lang"); var D=window.BP_DICT; if(l&&l!=="tg"&&D&&D[l]&&D[l][s]) return D[l][s]; }catch(e){} return s; }
...
$$("[data-bld-rail]").forEach(function(rail){
  ...
  var h = '<div class="rail-head">'+
            '<a class="adm-brand" href="services.html" title="eKhizmat · Конструктор"><svg class="mark" aria-hidden="true"><use href="#i-logo"/></svg><b>eKhizmat</b></a>'+
          '</div>';
  ...
  if(adm && !adm.querySelector("[data-rail-toggle]")){
    ...
    btn.innerHTML='<svg aria-hidden="true"><use href="#i-chev-l"/></svg>';
    adm.appendChild(btn);
  }
});
